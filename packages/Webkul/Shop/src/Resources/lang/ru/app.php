...
return [
    ...
    'cms-pages' => [
        'body-category' => 'Уход за телом',
        'face-category' => 'Уход за лицом',
        'hair-category' => 'Уход за волосами',
        'organic-category' => 'Органическая косметика',
        'korea-category' => 'Корейская косметика',
